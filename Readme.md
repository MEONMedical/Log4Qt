...
Requirements
------------
* Minimum Qt version required Qt 6.5 (for support of Qt versions down to 5.3 use branch 1.4 or the latest 1.4.x release
  or for support of Qt versions down to 5.7 use branch 1.6 or the latest 1.5.x release)
